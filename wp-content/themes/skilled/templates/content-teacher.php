...
<div class="teacher one third wh-padding">
	<div class="inner-wrap">
		<?php if ( has_post_thumbnail() ): ?>
			<div class="thumbnail">
				<?php echo wp_kses_post( skilled_get_thumbnail( array( 'thumbnail' => 'wh-medium' ) ) ); ?>
			</div>
		<?php endif; ?>
		<div class="item">
			...
			<?php if ( $summary ) : ?>
				<div
					class="summary"><?php echo wp_trim_words( do_shortcode( $summary ), apply_filters( 'skilled_teacher_summary_word_count', 10 ) ); ?></div>
			<?php else: ?>
				<div class="summary"><?php echo do_shortcode( get_the_excerpt() ); ?></div>
			<?php endif; ?>
			<?php $social_icons = skilled_get_rwmb_meta( 'social_icons', $post->ID ); ?>
			<?php if ( ! empty( $social_icons ) ): ?>
				<div class="social">
					<div class="text"><?php esc_html_e( 'Meet me on', 'skilled' ); ?></div>
