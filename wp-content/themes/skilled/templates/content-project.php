...
<div class="teacher one third wh-padding">
	...
	<div class="item">
		...
		<?php if ( $summary ) : ?>
			<div
				class="summary"><?php echo wp_trim_words( do_shortcode( $summary ), apply_filters( 'skilled_project_summary_word_count', 10 ) ); ?></div>
		<?php else: ?>
		...
		<?php if ( $social ) : ?>
			<div class="social">
				<div class="text"><?php esc_html_e( 'Meet us on:', 'skilled' ); ?></div>
