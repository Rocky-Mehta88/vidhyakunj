...
<?php if ( $results->have_posts() ): ?>
	<div class="vc_row linp-featured-courses-carousel wh-similar-courses">
		<div class="<?php echo esc_attr( skilled_class( 'container' ) ) ?>">
			<div class="<?php echo esc_attr( skilled_class( 'strecher' ) ) ?>">
							...
							<div class="cbp-row">
								<div class="one whole">
									<div class="course-lesson-count">
							        	...
							        	<?php echo esc_html( (int) $woothemes_sensei->post_types->course->course_lesson_count( $post->ID ) . '&nbsp;' . apply_filters( 'sensei_lessons_text', esc_html__( 'Lessons', 'skilled' ) ) ); ?>
									</div>
