...
function skilled_get_layout_blocks_css() {
	$css = '';
	foreach ( skilled_get_registered_layout_blocks() as $layout_block ) {
		$layout_block_id = skilled_get_layout_block_id( $layout_block );
		$css .= skilled_get_vc_page_custom_css( $layout_block_id );
		$css .= skilled_get_vc_shortcodes_custom_css( $layout_block_id );
	}
	return $css;
}
...
function skilled_get_vc_default_post_css() {
