...
function skilled_style_map() {

	return apply_filters( 'skilled-filter-style-map', array(
...
function skilled_get_style_from_options( $redux_options ) {
	$style = '';
	foreach (skilled_style_map() as $prop => $options ) {
